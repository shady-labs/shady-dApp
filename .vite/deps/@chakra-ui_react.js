...
import {
  ...
  useIsPresent,
  usePresence
} from "./chunk-QTAOW54S.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  require_hoist_non_react_statics_cjs,
  require_react_is
} from "./chunk-K6KFPE6B.js";
import {
  require_react_dom
      ...
      if (isMultipart) {
        (_b5 = config2.parts) == null ? void 0 : _b5.forEach((part) => {
          (0, import_lodash4.default)(result, {
            [part]: isSingle ? styles2[part] : { [query2]: styles2[part] }
          });
        });
        continue;
      }
...
function useHighlight(props) {
  ...
  return (0, import_react98.useMemo)(() => highlightWords({ text, query: query2 }), [text, query2]);
}
...
function Highlight(props) {
  const { children, query: query2, styles: styles2 } = props;
...
function useMediaQuery(query2, options = {}) {
  ...
  const [value, setValue] = (0, import_react101.useState)(() => {
    return queries.map((query22, index) => ({
      media: query22,
      matches: ssr ? !!fallbackValues[index] : getWindow3().matchMedia(query22).matches
    }));
  });
...
function Hide(props) {
  ...
  return (0, import_jsx_runtime96.jsx)(Visibility, { breakpoint: query2, hide: true, ssr, children });
}
...
function Show(props) {
  const { children, ssr } = props;
  const query2 = useQuery(props);
  return (0, import_jsx_runtime97.jsx)(Visibility, { breakpoint: query2, ssr, children });
}
...
function isElement4(node3) {
  var OwnElement = getWindow2(node3).Element;
  return node3 instanceof OwnElement || node3 instanceof Element;
}
function isHTMLElement4(node3) {
  var OwnElement = getWindow2(node3).HTMLElement;
...
function isShadowRoot(node3) {
  ...
  var OwnElement = getWindow2(node3).ShadowRoot;
...
function applyStyles(_ref2) {
  ...
  Object.keys(state2.elements).forEach(function(name) {
    ...
    if (!isHTMLElement4(element) || !getNodeName(element)) {
      return;
    }
...
function getBoundingClientRect(element, includeScale, isFixedStrategy) {
  ...
  var _ref2 = isElement4(element) ? getWindow2(element) : window, visualViewport = _ref2.visualViewport;
...
function getContainingBlock(element) {
  ...
  while (isHTMLElement4(currentNode) && ["html", "body"].indexOf(getNodeName(currentNode)) < 0) {
    var css4 = getComputedStyle2(currentNode);
    if (css4.transform !== "none" || css4.perspective !== "none" || css4.contain === "paint" || ["transform", "perspective"].indexOf(css4.willChange) !== -1 || isFirefox2 && css4.willChange === "filter" || isFirefox2 && css4.filter && css4.filter !== "none") {
      return currentNode;
    } else {
...
function effect3(_ref2) {
  ...
  if (!contains6(state2.elements.popper, arrowElement)) {
    return;
  }
...
function getScrollParent3(node3) {
  if (["html", "body", "#document"].indexOf(getNodeName(node3)) >= 0) {
    return node3.ownerDocument.body;
  }
  if (isHTMLElement4(node3) && isScrollParent2(node3)) {
    return node3;
  }
  return getScrollParent3(getParentNode2(node3));
}
...
function getClippingParents(element) {
  ...
  var clipperElement = canEscapeClipping && isHTMLElement4(element) ? getOffsetParent(element) : element;
  if (!isElement4(clipperElement)) {
    return [];
  }
  return clippingParents2.filter(function(clippingParent) {
    return isElement4(clippingParent) && contains6(clippingParent, clipperElement) && getNodeName(clippingParent) !== "body";
  });
}
...
function getNodeScroll(node3) {
  if (node3 === getWindow2(node3) || !isHTMLElement4(node3)) {
...
function isTargetMenuItem(target) {
  var _a8;
  return isHTMLElement5(target) && !!((_a8 = target == null ? void 0 : target.getAttribute("role")) == null ? void 0 : _a8.startsWith("menuitem"));
}
  ...
  const getRootProps = (0, import_react139.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...
        tabIndex: -1,
        "aria-disabled": ariaAttr4(isDisabled3),
        "data-focused": dataAttr4(isFocused),
  ...
  const getTrackProps = (0, import_react139.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...
        id: ids.track,
        "data-disabled": dataAttr4(isDisabled3),
  ...
  const getThumbProps = (0, import_react139.useCallback)(
    (props2, ref = null) => {
      ...
      return {
        ...
        "data-active": dataAttr4(isDragging && activeIndex === index),
        ...
        "aria-orientation": orientation,
        "aria-disabled": ariaAttr4(isDisabled3),
        "aria-readonly": ariaAttr4(isReadOnly),
  ...
  const getMarkerProps = (0, import_react139.useCallback)(
    (props2, ref = null) => {
      ...
      return {
        ...
        "aria-hidden": true,
        "data-disabled": dataAttr4(isDisabled3),
        "data-invalid": dataAttr4(!isInRange),
        "data-highlighted": dataAttr4(isHighlighted),
        style: {
          ...props2.style,
          ...markerStyle
        }
  ...
  const getThumbProps = (0, import_react141.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...
        tabIndex: isInteractive ? 0 : void 0,
        id: thumbId,
        "data-active": dataAttr4(isDragging),
...
function useTooltip(props = {}) {
  ...
  useEventListener(
    () => {
      ...
      if (!node3)
        return null;
      const scrollParent = getScrollParent2(node3);
